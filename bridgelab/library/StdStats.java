   ...
   */
   ...
   /**
    ...
    public static void plotPoints(double[] a) {
        validateNotNull(a);
        int n = a.length;
        StdStats.setXscale(-1, n);
        StdStats.setPenRadius(1.0 / (3.0 * n));
        for (int i = 0; i < n; i++) {
            StdStats.point(i, a[i]);
        }
    }
   ...
   /**
    ...
    public static void plotLines(double[] a) {
        ...
        int n = a.length;
        StdStats.setXscale(-1, n);
        StdStats.setPenRadius(n);
        for (int i = 1; i < n; i++) {
            StdStats.line(i-1, a[i-1], i, a[i]);
        }
    }
   ...
   /**
    ...
    public static void plotBars(double[] a) {
        ...
        StdStats.setXscale(-1, n);
        for (int i = 0; i < n; i++) {
            StdStats.filledRectangle(i, a[i]/2, 0.25, a[i]/2);
        }
    }
